...
var Divider = React4.forwardRef(function Divider2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDivider"
  });
  ...
  return (0, import_jsx_runtime5.jsx)(DividerRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    role,
    ref,
    ...
    children: children ? (0, import_jsx_runtime5.jsx)(DividerWrapper, {
...
var ListItemIcon = React5.forwardRef(function ListItemIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime6.jsx)(ListItemIconRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
var _excluded5 = ["children", "className", "disableTypography", "inset", "primary", "primaryTypographyProps", "secondary", "secondaryTypographyProps"];
...
var ListItemText = React6.forwardRef(function ListItemText2(inProps, ref) {
  ...
  if (primary != null && primary.type !== Typography_default && !disableTypography) {
    primary = (0, import_jsx_runtime7.jsx)(Typography_default, _extends({
  ...
  if (secondary != null && secondary.type !== Typography_default && !disableTypography) {
    secondary = (0, import_jsx_runtime7.jsx)(Typography_default, _extends({
      variant: "body2",
  ...
  return (0, import_jsx_runtime8.jsxs)(ListItemTextRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref
  }, other, {
...
var _excluded6 = ["autoFocus", "component", "dense", "divider", "disableGutters", "focusVisibleClassName", "role", "tabIndex", "className"];
...
var MenuItem = React7.forwardRef(function MenuItem2(inProps, ref) {
  ...
  return (0, import_jsx_runtime9.jsx)(ListContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime9.jsx)(MenuItemRoot, _extends({
      ref: handleRef,
      role,
      tabIndex,
      component,
...
//# sourceMappingURL=chunk-QOZYXYEC.js.map
